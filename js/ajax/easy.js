...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__13406 = cljs.core.second(format);
var G__13407 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__13406,G__13407) : ajax.easy.keyword_response_format_element.call(null,G__13406,G__13407));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13410_SHARP_){
return ajax.easy.keyword_response_format_element(p1__13410_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__13419){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13420__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13420__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13420__$1,cljs.core.cst$kw$finally);
var h = (function (){var or__7488__auto__ = handler;
...
var e = (function (){var or__7488__auto__ = error_handler;
if(cljs.core.truth_(or__7488__auto__)){
return or__7488__auto__;
} else {
...
return ((function (h,e,map__13420,map__13420__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__13429){
var vec__13430 = p__13429;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13430,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13430,(1),null);
var fexpr__13433_13440 = (cljs.core.truth_(ok)?h:e);
(fexpr__13433_13440.cljs$core$IFn$_invoke$arity$1 ? fexpr__13433_13440.cljs$core$IFn$_invoke$arity$1(result) : fexpr__13433_13440.call(null,result));
...
;})(h,e,map__13420,map__13420__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__13441){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13442__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13442__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13442__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13442__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13442__$1,cljs.core.cst$kw$body);

var needs_format = ((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET"));
var rf = (cljs.core.truth_((function (){var or__7488__auto__ = format;
if(cljs.core.truth_(or__7488__auto__)){
return or__7488__auto__;
} else {
return needs_format;
