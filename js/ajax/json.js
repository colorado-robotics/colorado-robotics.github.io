...
if(cljs.core.truth_((function (){var and__7476__auto__ = prefix;
...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__13284){
...
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13286__$1,cljs.core.cst$kw$prefix);
var keywords_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13286__$1,cljs.core.cst$kw$keywords_QMARK_);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13286__$1,cljs.core.cst$kw$raw);
return ajax.interceptors.map__GT_ResponseFormat(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$read,((function (map__13286,map__13286__$1,prefix,keywords_QMARK_,raw){
return (function ajax$json$make_json_response_format_$_json_response_format_$_json_read_response_format(xhrio){
var G__13288 = raw;
var G__13289 = keywords_QMARK_;
var G__13290 = ajax.json.strip_prefix(prefix,ajax.protocols._body(xhrio));
return (read_json.cljs$core$IFn$_invoke$arity$3 ? read_json.cljs$core$IFn$_invoke$arity$3(G__13288,G__13289,G__13290) : read_json.call(null,G__13288,G__13289,G__13290));
});})(map__13286,map__13286__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__13284){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__13284);
}
