...
var m__8158__auto__ = (hipo.interceptor._intercept[goog.typeOf(x__8157__auto__)]);
if(!((m__8158__auto__ == null))){
return (m__8158__auto__.cljs$core$IFn$_invoke$arity$4 ? m__8158__auto__.cljs$core$IFn$_invoke$arity$4(this$,t,m,f) : m__8158__auto__.call(null,this$,t,m,f));
} else {
var m__8158__auto____$1 = (hipo.interceptor._intercept["_"]);
if(!((m__8158__auto____$1 == null))){
return (m__8158__auto____$1.cljs$core$IFn$_invoke$arity$4 ? m__8158__auto____$1.cljs$core$IFn$_invoke$arity$4(this$,t,m,f) : m__8158__auto____$1.call(null,this$,t,m,f));
} else {
...
hipo.interceptor.LogInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/LogInterceptor");
});
...
var self__ = this;
var ___$2 = this;
var label = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self__.s),cljs.core.str.cljs$core$IFn$_invoke$arity$1("-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(t))].join('');
console.time(label);
...
hipo.interceptor.TimeInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/TimeInterceptor");
});
...
hipo.interceptor.ProfileInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/ProfileInterceptor");
});
...
var self__ = this;
var ___$2 = this;
var mark_begin = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self__.label),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" begin "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(t)].join('');
var mark_end = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self__.label),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" end "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(t)].join('');
...
return performance.measure([cljs.core.str.cljs$core$IFn$_invoke$arity$1(self__.label),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(t)].join(''),mark_begin,mark_end);
});
...
hipo.interceptor.PerformanceInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/PerformanceInterceptor");
});
...
return (function (p1__13423_SHARP_,p2__13422_SHARP_){
return cljs.core.cons(p2__13422_SHARP_,p1__13423_SHARP_);
});})(___$1))
...
hipo.interceptor.StateInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/StateInterceptor");
});
...
hipo.interceptor.StaticReconciliationInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/StaticReconciliationInterceptor");
});
...
hipo.interceptor.IdentityReconciliationInterceptor.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.interceptor/IdentityReconciliationInterceptor");
});
