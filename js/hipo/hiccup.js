...
var or__7488__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$namespaces.cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__13375 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__13375;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__7476__auto__ = id;
...
if(cljs.core.truth_((function (){var or__7488__auto__ = id;
if(cljs.core.truth_(or__7488__auto__)){
return or__7488__auto__;
} else {
return cs;
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m_QMARK_,(cljs.core.truth_(id)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,id], null):null),(cljs.core.truth_(cs)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,(function (){var temp__4655__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(m_QMARK_);
if(cljs.core.truth_(temp__4655__auto__)){
var c = temp__4655__auto__;
if(cljs.core.truth_(cs)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cs),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(c)].join('');
} else {
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__8099__auto__,writer__8100__auto__,opt__8101__auto__){
return cljs.core._write(writer__8100__auto__,"hipo.hiccup/Sentinel");
});
...
while(true){
if(cljs.core.seq(s)){
var G__13417 = (function (){var f = cljs.core.first(s);
if(cljs.core.truth_((function (){var or__7488__auto__ = hipo.hiccup.literal_QMARK_(f);
if(cljs.core.truth_(or__7488__auto__)){
return or__7488__auto__;
} else {
...
var G__13434 = ((cljs.core.seq_QMARK_(f))?hipo.hiccup.conjs_BANG_(acc,f):((!((f == null)))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,f):acc
));
var G__13435 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(v__$1,(1));
acc = G__13434;
v__$1 = G__13435;
continue;
}
